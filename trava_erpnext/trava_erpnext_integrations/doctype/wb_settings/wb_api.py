...
class MWS(object):
	...
	def make_request(self, extra_data ='', method="GET", type_request=None, reportType=None, dateFrom=None, 
		dateTo=None, flag=None, rrd_id=None, **kwargs):
		"""Make request to Amazon MWS API with these parameters
		"""
		if type_request == "report":
			params = {
				'key': self.access_key
			}
